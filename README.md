...
First up, let's create our own asset.
as this is an action so You can do so by running the following
...
```
txdID is the crucial id required for further commands like checking the balance and creating and all
...
#### Step 4(if required): Close Order
